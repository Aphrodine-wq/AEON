...
from aeon.abstract_interp import abstract_interpret
...
from aeon.api_contract import check_api_contracts
from aeon.numeric_safety import check_numeric_safety
...
class TypeChecker:
    ...
    def __init__(self, verify_contracts: bool = False, analyze_termination: bool = False, track_memory: bool = False,
        ...
        self.api_contracts = api_contracts or deep_verify
        self.numeric_safety = numeric_safety or deep_verify
